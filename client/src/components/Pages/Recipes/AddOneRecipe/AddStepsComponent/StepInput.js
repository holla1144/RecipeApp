...
const StepInput = (props) => {
  return (
    <div className="step_input-container">
      ...
      <textarea className="col-6 step_input-container_input" placeholder={"Describe step " + (props.index + 1) }
                id={ 'stepinput-' + props.index } value={ props.text } index={ props.index } onChange={ props.handleChange }></textarea>
